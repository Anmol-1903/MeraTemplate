...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRKnobDual : XRBaseInteractable
    {
        ...
        void StartGrab(SelectEnterEventArgs args)
        {
            ...
            {
                m_SecondInteractor = (XRBaseInteractor)args.interactorObject;
            }
        ...
        {
            if (m_Interactor == args.interactorObject)
            {
                m_Interactor = null;
            }
            else
        ...
        public XRBaseInteractor m_SecondInteractor;
        void UpdateRotation(bool freshCheck = false)
        {
            // Check if both hands are interacting with the knob
            if (m_Interactor != null && m_SecondInteractor != null)
            {
                ...
                localUp.y = 0.0f;
                localUp.Normalize();
                // Rest of the rotation logic here...
            ...
            {
                // Don't rotate the knob if only one hand is interacting
                return;
            }
        }
